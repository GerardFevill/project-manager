...
@ApiTags('cumulative-flow')
@Controller('cumulative-flow')
@UseGuards(JwtAuthGuard)
@ApiBearerAuth()
export class CumulativeFlowController {
  constructor(private readonly service: CumulativeFlowService) {}

  @Post()
  @ApiOperation({ summary: 'Create' })
  @ApiResponse({ status: 201 })
  create(@Body() dto: CreateCumulativeFlowDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateCumulativeFlowDto) { return this.service.update(id, dto); }
