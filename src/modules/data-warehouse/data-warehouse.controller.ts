...
export class DataWarehouseController {
  constructor(private readonly service: DataWarehouseService) {}

  @Post()
  @ApiOperation({ summary: 'Create' })
  @ApiResponse({ status: 201 })
  create(@Body() dto: CreateDataWarehouseDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateDataWarehouseDto) { return this.service.update(id, dto); }
