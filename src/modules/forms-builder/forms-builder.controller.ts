...
@Controller('forms-builder')
@UseGuards(JwtAuthGuard)
@ApiBearerAuth()
export class FormsBuilderController {
  constructor(private readonly service: FormsBuilderService) {}

  @Post()
  @ApiOperation({ summary: 'Create' })
  @ApiResponse({ status: 201 })
  create(@Body() dto: CreateFormTemplateDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateFormTemplateDto) { return this.service.update(id, dto); }
