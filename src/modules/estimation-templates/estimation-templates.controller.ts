...
export class EstimationTemplatesController {
  ...
  create(@Body() dto: CreateEstimationTemplateDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateEstimationTemplateDto) { return this.service.update(id, dto); }
