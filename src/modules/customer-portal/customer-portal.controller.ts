...
export class CustomerPortalController {
  ...
  create(@Body() dto: CreateCustomerTicketDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateCustomerTicketDto) { return this.service.update(id, dto); }
