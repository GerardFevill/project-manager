...
@ApiTags('workflow-schemes')
@Controller('workflow-schemes')
@UseGuards(JwtAuthGuard)
@ApiBearerAuth()
export class WorkflowSchemesController {
  constructor(private readonly service: WorkflowSchemesService) {}

  @Post()
  @ApiOperation({ summary: 'Create' })
  @ApiResponse({ status: 201 })
  create(@Body() dto: CreateWorkflowSchemeDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateWorkflowSchemeDto) { return this.service.update(id, dto); }
