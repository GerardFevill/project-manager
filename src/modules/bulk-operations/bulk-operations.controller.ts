...
export class BulkOperationsController {
  ...
  create(@Body() dto: CreateBulkOperationDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateBulkOperationDto) { return this.service.update(id, dto); }
