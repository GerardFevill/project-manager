...
@Controller('project-cloning')
@UseGuards(JwtAuthGuard)
@ApiBearerAuth()
export class ProjectCloningController {
  constructor(private readonly service: ProjectCloningService) {}

  @Post()
  @ApiOperation({ summary: 'Create' })
  @ApiResponse({ status: 201 })
  create(@Body() dto: CreateCloneOperationDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateCloneOperationDto) { return this.service.update(id, dto); }
