...
export class PermissionSchemesController {
  constructor(private readonly service: PermissionSchemesService) {}

  @Post()
  @ApiOperation({ summary: 'Create' })
  @ApiResponse({ status: 201 })
  create(@Body() dto: CreatePermissionSchemeDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdatePermissionSchemeDto) { return this.service.update(id, dto); }
