...
export class ImportExportController {
  ...
  create(@Body() dto: CreateImportExportDto) { return this.service.create(dto); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateImportExportDto) { return this.service.update(id, dto); }
